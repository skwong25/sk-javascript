...
// Express is a JS framework for creating web servers and APIs
...
// HTTP follows one request-one response cycle
// 
...
// In the above code snippet, a .get() route is defined to match /monster/:name path
